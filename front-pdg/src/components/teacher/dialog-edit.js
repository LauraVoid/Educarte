...
const EditTeacher = (props) => {
  const { teacherSelected, handleReload, closeEdit } = props;
  ...
  const [teacherState, setTeacherState] = useState({
    ...
    values: {
      ...
      identification: teacherSelected.idDocument,
      name: teacherSelected.name,
      lastname: teacherSelected.lastname,
      cellphone: teacherSelected.phone,
  ...
  const handleSubmit = (event) => {
    ...
    axios
      ...
      .then((res) => {
        if (res.status === 200) {
          let message = {
            errorMsg: "Profesor actualizado con éxito",
            errorType: "success",
          };
          ...
          console.log("hubo un error al actualizar al profesor");
          closeEdit();
        }
      })
      .catch((error) => {
          ...
          <form className={classes.root}>
            <Grid item xs={12} className={classes.centrado}>
              <TextField
                ...
                label="Nombres"
                name="name"
                defaultValue={teacherSelected.name}
                type="text"
            ...
            <Grid item xs={12} className={classes.centrado}>
              <TextField
                ...
                label="Apellidos"
                name="lastname"
                defaultValue={teacherSelected.lastname}
                onChange={handleChange}
            ...
            <Grid item xs={12} className={classes.centrado}>
              <TextField
                ...
                name="identification"
                defaultValue={teacherSelected.idDocument}
                onChange={handleChange}
          ...
          <form className={classes.root}>
            <Grid item xs={12} className={classes.centrado}>
              <TextField
                ...
                id="standard-basic"
                label="Celular"
                defaultValue={teacherSelected.phone}
                name="cellphone"
                onChange={handleChange}
            ...
            <Grid item xs={12} className={classes.centrado}>
              <TextField
                ...
                label="Correo"
                name="email"
                defaultValue={teacherSelected.email}
                onChange={handleChange}
